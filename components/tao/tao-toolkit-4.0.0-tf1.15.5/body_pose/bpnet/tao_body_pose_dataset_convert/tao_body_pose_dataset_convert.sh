...
echo dataset_convert -m $MODE -o $TF_RECORDS_DIR/$MODE --generate_masks --dataset_spec $SPECS_DIR/$DATASET_EXPORT_SPEC
bpnet dataset_convert -m $MODE -o $TF_RECORDS_DIR/$MODE --generate_masks --dataset_spec $SPECS_DIR/$DATASET_EXPORT_SPEC