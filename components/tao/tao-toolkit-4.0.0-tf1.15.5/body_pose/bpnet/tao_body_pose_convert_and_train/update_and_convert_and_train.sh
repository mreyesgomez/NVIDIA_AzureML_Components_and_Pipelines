...
bash ./update_specs.sh ${ORIGINAL_SPECs_DIR}/data_pose_config ${UPDATED_SPECs_DIR} ${DATASET_EXPORT_SPEC} ${SPECFILE_REFERENCE_DATA_DIR}:${DATA_DIR},${RELATIVE_TRAIN_MASK_DIRECTORY}:${TF_RECORDS_DIR}/${RELATIVE_TRAIN_MASK_DIRECTORY},${RELATIVE_VAL_MASK_DIRECTORY}:${TF_RECORDS_DIR}/${RELATIVE_VAL_MASK_DIRECTORY}
...
ls -l ${TF_RECORDS_DIR}/${RELATIVE_TRAIN_MASK_DIRECTORY}

bash ./update_train_specs.sh ${ORIGINAL_TRAIN_SPECs_DIR} ${UPDATED_TRAIN_SPECs_DIR} ${SPEC_FILE} 'num_epochs: [0-9]\+'%'num_epochs: '${NUM_EPOCHS},${SPECFILE_REFERENCE_TRAINING_DATA_DIR}%${TRAINING_DATA_DIR},${SPECFILE_REFERENCE_TRAINING_TF_RECORDS_DIR}%${TF_RECORDS_DIR}/${RELATIVE_TRAIN_MASK_DIRECTORY},${SPECFILE_REFERENCE_MODEL_DIR}%${BASE_MODEL_DIR}/${MODEL_NAME},${SPECFILE_MODEL_POSE_DIR}%${ORIGINAL_SPECs_DIR}/model_pose_config/bpnet_18joints.json,${SPECFILE_DATA_POSE_DIR}%${ORIGINAL_SPECs_DIR}/data_pose_config/coco_spec.json
