...
then
    # TODO change me
    bash ./update_specs.sh ${ORIGINAL_SPECs_DIR} ${UPDATED_SPECs_DIR} ${SPEC_FILE} 'num_epochs: [0-9]\+'%'num_epochs: '${NUM_EPOCHS},${SPECFILE_REFERENCE_TRAINING_DATA_DIR}%${TRAINING_DATA_DIR},${SPECFILE_REFERENCE_TRAINING_TF_RECORDS_DIR}%${TRAINING_TF_RECORDS_DIR},${SPECFILE_REFERENCE_MODEL_DIR}%${BASE_MODEL_DIR}/${MODEL_NAME},${SPECFILE_MODEL_POSE_DIR}%${ORIGINAL_SPECs_DIR}/model_pose_config,${SPECFILE_DATA_POSE_DIR}%${ORIGINAL_SPECs_DIR}/data_pose_config
else
    bash ./update_specs.sh ${ORIGINAL_SPECs_DIR} ${UPDATED_SPECs_DIR} ${SPEC_FILE} 'num_epochs: [0-9]\+'%'num_epochs: '${NUM_EPOCHS},${SPECFILE_REFERENCE_TRAINING_DATA_DIR}%${TRAINING_DATA_DIR},${SPECFILE_REFERENCE_TRAINING_TF_RECORDS_DIR}%${TRAINING_TF_RECORDS_DIR},${SPECFILE_REFERENCE_MODEL_DIR}%${BASE_MODEL_DIR}/${MODEL_NAME},${SPECFILE_MODEL_POSE_DIR}%${ORIGINAL_SPECs_DIR}/model_pose_config,${SPECFILE_DATA_POSE_DIR}%${ORIGINAL_SPECs_DIR}/data_pose_config
fi
